...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'mts-inline-flex mts-items-center mts-justify-center mts-rounded-md mts-font-medium mts-transition-colors mts-focus:mts-outline-none mts-focus:mts-ring-2 mts-focus:mts-ring-offset-2';

  const variants = {
    primary:
      'mts-bg-primary-500 mts-text-white hover:mts-bg-primary-600 mts-focus:mts-ring-primary-500',
    secondary:
      'mts-bg-gray-100 mts-text-gray-900 hover:mts-bg-gray-200 mts-focus:mts-ring-gray-500',
